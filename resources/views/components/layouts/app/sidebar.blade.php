    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Management')" class="grid">
                ...
                <flux:navlist.item icon="wallet" :href="route('payment.method.index')"
            ...
            <flux:navlist.group :heading="__('Inventory Management')" class="grid">
                <flux:navlist.item icon="cube" :href="route('items.index')"
                    :current="request()->routeIs('items.index')" wire:navigate>{{ __('Items') }}
                </flux:navlist.item>
                <flux:navlist.item icon="rectangle-stack" :href="route('inventories.index')"
                    :current="request()->routeIs('inventories.method.index')" wire:navigate>
                    {{ __('Inventory') }}
                </flux:navlist.item>
            </flux:navlist.group>
            ...
            <flux:navlist.group :heading="__('Sales')" class="grid">
                <flux:navlist.item icon="shopping-bag" :href="route('sales.index')"
                    :current="request()->routeIs('sales.index')" wire:navigate>{{ __('Sales') }}
                </flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
